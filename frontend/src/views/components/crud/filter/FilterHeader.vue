  ...
  <div class="border-x border-x-third px-4">
    <div class="flex items-center relative border border-third rounded-3xl">
      <div class="relative w-full">
        ...
        <input type="text" @input="oneInputFilter" v-model="filterFormData[searchBy]"
          class="text-gray-900 text-sm block w-full pl-10 p-2.5 outline-none bg-transparent" placeholder="Search" />
      </div>
